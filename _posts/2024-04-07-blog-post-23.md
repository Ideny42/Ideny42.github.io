...
<img src='/images/23-1.png' width='1000' height='auto'>
...
<img src='/images/23-5.png' width='1000' height='auto'>
...
<img src='/images/23-6.png' width='1000' height='auto'>
把矩阵分解成方向矩阵和长度矩阵，再微调。

### Delta-LoRA

<img src='/images/23-7.png' width='1000' height='auto'>
Delta-LoRA 的作者提出用 AB 的梯度来更新矩阵 W，AB 的梯度是 A\*B 在连续两个时间步长的差。这个梯度用超参数 \( \lambda \) 进行缩放，\( \lambda \) 控制新训练对预训练权重的影响有多大。
<img src='/images/23-8.png' width='1000' height='auto'>

### MoRAL

<img src='/images/23-9.png' width='1000' height='auto'>
引入低秩矩阵来分解与预训练 LLMs 对应的权重矩阵。使用这些低秩矩阵作为专家，应用在预训练模型之上。通过一个门控机制，也被称为路由网络，允许在多个专家上进行条件计算。

### QLoRA

<img src='/images/23-10.png' width='1000' height='auto'>
...
<img src='/images/23-11.png' width='1000' height='auto'>
...
<img src='/images/23-12.png' width='1000' height='auto'>
